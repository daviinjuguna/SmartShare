      ...
      body: BlocConsumer<CommentBloc, CommentState>(
        ...
        builder: (context, state) {
          ...
          if (state is Created) {
            ...
            //! return state to success so as preventing comments to be inserted by the above method
            widget.bloc.add(UpdateCommentEvent(postId: widget.widget.post.id));

            widget.widget.postBloc.add(postBloc.UpdatePostEvent());
          }
          return Material(
            color: Colors.white,
            child: Column(
